...
1. 將以上項目新增至 SSO 節點下的 config.xml 檔案，但在項目 *&lt;node name=“AllowedUrls“>* 後面：
   ...
   關於更新 config.xml 檔案的詳細步驟資訊，請參閱 [手動編輯 Document Security 設定檔案](https://helpx.adobe.com/aem-forms/6-3/admin-help/configuring-client-server-options.html#manually_editing_the_document_security_configuration_file)。
...
若要了解建立和管理原則的更多資訊，請參閱 [Document Security 用戶說明](http://help.adobe.com/en_US/AEMForms/6.1/RMHelp/)。
